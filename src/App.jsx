    ...
    <Card style={{marginBottom:16,padding:0,overflow:"hidden",background:"#FFF",border:`1px solid ${temSwap?B[200]:W[200]}`}} ariaLabel={`Cesta da semana: ${D.entrega.dia}`}>
      ...
      <div style={{padding:"20px 20px 12px"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",gap:8,marginBottom:12}}>
          ...
          {temSwap
            ?<span style={{fontFamily:fb,fontSize:11,fontWeight:500,padding:"3px 8px",borderRadius:4,background:W[200],color:W[800],whiteSpace:"nowrap"}}>editada só nesta semana</span>
            :temExtras
...
const Assinatura=({onNav,hasPending,cutoff,assinaturaQtds,assinaturaBaseline,onSalvar})=>{
  ...
  return<div style={{padding:"24px 16px 16px",paddingBottom:hasPending?80:16}}>
    ...
    <div style={{background:B[50],borderRadius:12,padding:16,marginBottom:16,fontFamily:fb,fontSize:14,color:B[800],lineHeight:1.6}}>Toda semana, pão fresco na sua porta. O valor da Assinatura é fixo. Em meses com 5 semanas, o pão extra é por nossa conta.</div>
