...
const D={
  ...
  pães:[
    {id:"original",nome:"Pão Original",peso:"~700g",preco:"R$ 30,00",precoNum:30,genero:"m",img:IMG.original,desc:"O pão do dia a dia. Vai com manteiga no café e com azeite no jantar.",sobre:"Foi com esse pão que tudo começou. Repeti a receita por anos até chegar num resultado que me dava orgulho, e foi nesse caminho que a paixão pela panificação virou ofício. Farinha italiana com um toque de integral brasileira, artesanal e moída a pedra, pra ganhar sabor. Fermentação longa e 70% de hidratação para um miolo aberto e o sabor que só o tempo constrói.",ingredientes:"Farinha de trigo italiana, água mineral, levain Cora, farinha integral Fazenda Vargem, sal marinho",subCopy:"O pão que começou tudo.",qtd:1},
    {id:"integral",nome:"Pão Integral",peso:"~700g",preco:"R$ 30,00",precoNum:30,genero:"m",img:IMG.integral,desc:"A versão integral do Original. Leve, macia, com gergelim na crosta.",sobre:"A versão integral tinha que ser tão versátil quanto o Original: leve, macia, longe daqueles integrais que parecem tijolo. Farinha 100% integral da Fazenda Vargem, artesanal e moída a pedra, com o gérmen e a fibra da casca. O azeite extra virgem na massa é o que traz a maciez, e o gergelim preto fecha a crosta. Fermentação com o levain Cora, 75% de hidratação.",ingredientes:"Farinha integral Fazenda Vargem, água mineral, levain Cora, azeite extra virgem, sal marinho, gergelim preto",subCopy:"Integral leve, todo dia.",qtd:0},
  ],
  rotativos:[
    {id:"multigraos",nome:"Multigrãos",peso:"~650g",preco:"R$ 36,00",precoNum:36,genero:"m",img:IMG.multigraos,desc:"Seis grãos torrados e escaldados no miolo. Crosta de aveia. O pão das ocasiões.",sobre:"Aprendi a receita com Alex Duarte, do ISPA. Seis grãos no miolo, crosta de aveia fina. Torrar e escaldar os grãos antes de incorporar é o que traz o perfume e a profundidade de sabor. É o pão mais indulgente da Cora, pra uma celebração que pode ser do dia a dia ou de algo especial. 112% de hidratação.",ingredientes:"Farinha de trigo italiana, farinha integral Fazenda Vargem, água mineral, gergelim branco sem casca, gergelim preto, quinoa, linhaça dourada, semente de girassol, semente de abóbora, aveia fina, levain Cora, sal marinho",subCopy:"Pra torrada com abacate, e pra sopa que vira jantar."},
    {id:"focaccia",nome:"Focaccia Genovesa",peso:"~420g",preco:"R$ 28,00",precoNum:28,genero:"f",img:IMG.focaccia,desc:"Joia da Ligúria. Macia por dentro, dourada por fora. Cebola roxa macerada, azeite infusionado com alecrim e flor de sal.",sobre:"Joia da culinária da Ligúria, no norte da Itália. A genovesa autêntica é fina, com uns 2 cm, miolo muito macio e crosta dourada e levemente crocante. O segredo está na generosidade do azeite extra virgem e na salmoura que preenche os buraquinhos característicos. A tradição leva alecrim e sal; na Cora entra também cebola roxa macerada no vinagre. É um pão meio pizza, leve, com cobertura que dá vontade de comer o tabuleiro inteiro. Sai do forno inteira e vai vendida em pedaços.",ingredientes:"Farinha de trigo italiana, água mineral, azeite extra virgem infusionado com alecrim, levain Cora, cebola roxa, vinagre de vinho branco, flor de sal, sal marinho",subCopy:"Pra um café da tarde diferente, e pra mesa cheia de gente."},
    {id:"ciabatta",nome:"Ciabatta",peso:"~550g",preco:"R$ 25,00",precoNum:25,genero:"f",img:IMG.ciabatta,desc:"Miolo cheio de alvéolos, casca fina e crocante. O pão do sanduíche ou da refeição.",sobre:"Ciabatta quer dizer chinelo em italiano, pelo formato achatado e largo. É invenção recente: criada em 1982 por Arnaldo Cavallari, perto de Veneza, pra fazer frente à baguete francesa nos sanduíches. As bolhas grandes vêm da hidratação alta, 80% aqui, e de uma massa úmida que quase não se deixa segurar. Farinha italiana com um pouco de integral moída a pedra, e azeite na massa, que é o que deixa a casca fina. Miolo leve e elástico, farinha generosa por fora.",ingredientes:"Farinha de trigo italiana, farinha integral Fazenda Vargem, água mineral, levain Cora, azeite extra virgem, sal marinho",subCopy:"Para o sanduíche caprichado, e pra limpar o molho do prato."},
    {id:"brioche",nome:"Brioche",peso:"~350g",preco:"R$ 36,00",precoNum:36,genero:"m",img:IMG.brioche,desc:"Macio como bolo. Uma fatia puxa a outra: com manteiga, torrado, no sanduíche ou puro.",sobre:"Brioche que junta a tradição francesa com a técnica italiana. Farinha italiana com um toque de sêmola, ovos, manteiga, leite e mel. A massa fermenta devagar, de um dia para o outro, e é daí que vem a maciez que se desmancha e o cheiro de manteiga que toma a cozinha. Doçura discreta, do tipo que combina com tudo, da geleia ao requeijão. Desenhei pensando no lanche da escola. Descobri que ele some antes, ainda no café da manhã.",ingredientes:"Farinha italiana, sêmola rimacinata, ovos, manteiga sem sal, leite integral, levain Cora, açúcar, mel, fermento seco, sal marinho",subCopy:"Uma fatia puxa a outra."},
  ],
